...
const NewArrivals = () => {
  ...
  useEffect(() => {
    ...
    switch (sortBy) {
      ...
      case 'newest':
      default:
        // Newest - keep original order (newest first)
        break;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-black via-charcoal to-primary-black relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-primary-gold via-gold-light to-burgundy py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            <span className="group bg-burgundy text-primary-white px-6 py-3 rounded-full text-sm font-bold animate-pulse-slow transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              ✨ NEW ARRIVALS
            </span>
          </div>
          <h1 className="text-6xl md:text-7xl font-bold text-charcoal mb-8 animate-fade-in">
            <span className="bg-gradient-to-r from-primary-gold via-gold-light to-burgundy bg-clip-text text-transparent animate-shimmer">Latest</span> Collection
          </h1>
          <p className="text-2xl text-charcoal mb-12 max-w-4xl mx-auto animate-slide-up leading-relaxed">
            Discover our newest arrivals featuring exclusive designs and limited edition pieces
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
            ...
            <div className="relative">
              <select
                ...
                className="bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-primary-white focus:outline-none focus:ring-2 focus:ring-primary-gold focus:border-transparent appearance-none pr-8"
              >
                <option value="newest" className="bg-primary-black">Newest First</option>
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-4xl font-bold text-primary-white mb-6 animate-fade-in">No New Arrivals Found</h3>
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 flex flex-col space-y-2">
                    <span className="bg-primary-gold text-primary-black px-3 py-1 rounded-full text-xs font-bold animate-pulse-slow">
                      NEW
                    </span>
                    {product.isLimited && (
                      <span className="bg-burgundy text-primary-white px-3 py-1 rounded-full text-xs font-bold animate-pulse-slow">
                        LIMITED
                      </span>
                    )}
                    {product.isSale && (
