...
const Women = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-black via-charcoal to-primary-black py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-br from-burgundy/20 to-primary-gold/20 rounded-full blur-3xl animate-float"></div>
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-br from-primary-gold/20 to-burgundy/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-br from-burgundy-light/10 to-burgundy/10 rounded-full blur-2xl animate-pulse-slow"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-burgundy/5 to-primary-gold/5 rounded-xl animate-pulse-slow"></div>
            </div>
            <div className="relative">
              <div className="bg-white/10 rounded-xl h-8 w-1/2 animate-pulse"></div>
              <div className="absolute inset-0 bg-gradient-to-r from-burgundy/5 to-primary-gold/5 rounded-xl animate-pulse-slow" style={{ animationDelay: '0.5s' }}></div>
            </div>
          </div>
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <div key={i} className="space-y-6 group">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-burgundy/5 to-primary-gold/5 rounded-2xl animate-pulse-slow" style={{ animationDelay: `${i * 0.1}s` }}></div>
                </div>
                <div className="space-y-3">
                  <div className="relative">
                    <div className="bg-white/10 rounded-xl h-5 w-3/4 animate-pulse"></div>
                    <div className="absolute inset-0 bg-gradient-to-r from-burgundy/5 to-primary-gold/5 rounded-xl animate-pulse-slow" style={{ animationDelay: `${i * 0.1 + 0.2}s` }}></div>
                  </div>
                  <div className="relative">
                    <div className="bg-white/10 rounded-xl h-5 w-1/2 animate-pulse"></div>
                    <div className="absolute inset-0 bg-gradient-to-r from-burgundy/5 to-primary-gold/5 rounded-xl animate-pulse-slow" style={{ animationDelay: `${i * 0.1 + 0.4}s` }}></div>
                  </div>
                </div>
              </div>
            ))}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-black via-charcoal to-primary-black relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-burgundy via-burgundy-light to-burgundy-dark py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-6xl md:text-7xl font-bold text-primary-white mb-8 animate-fade-in">
            <span className="bg-gradient-to-r from-burgundy-light via-primary-gold to-burgundy bg-clip-text text-transparent animate-shimmer">Women's</span> Collection
          </h1>
          <p className="text-2xl text-gold-light mb-12 max-w-4xl mx-auto animate-slide-up leading-relaxed">
            Discover timeless elegance and contemporary style in our premium women's fashion collection
          </p>
          <div className="flex flex-wrap justify-center gap-6 text-sm animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <span className="group bg-white/20 text-primary-white px-6 py-3 rounded-full font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              Free Shipping
            </span>
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20">
            <div className="relative mb-12">
              <div className="w-40 h-40 mx-auto bg-gradient-to-br from-burgundy/30 to-primary-gold/30 rounded-full flex items-center justify-center mb-8 animate-pulse-slow">
                <svg className="w-20 h-20 text-burgundy-light transform group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
              </div>
              <div className="absolute inset-0 w-40 h-40 mx-auto bg-gradient-to-br from-burgundy/10 to-primary-gold/10 rounded-full blur-xl animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
            </div>
            
            <h3 className="text-4xl font-bold text-primary-white mb-6 animate-fade-in">No Women's Products Found</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
            {filteredProducts.map((product, index) => (
              <div
                key={product.id}
                className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden hover:bg-white/10 transition-all duration-700 transform hover:-translate-y-4 hover:shadow-2xl hover:shadow-burgundy/20 animate-fade-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                {/* Glow Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-burgundy/0 to-primary-gold/0 rounded-3xl group-hover:from-burgundy/10 group-hover:to-primary-gold/10 transition-all duration-700"></div>
                {/* Product Image */}
                <div className="relative overflow-hidden">
                  ...
                  <button 
                      ...
                      className="group relative w-full bg-gradient-to-r from-burgundy to-burgundy-dark text-primary-white py-4 rounded-xl font-semibold hover:from-burgundy-dark hover:to-burgundy transition-all duration-500 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-xl overflow-hidden"
                    >
                      {/* Animated Background */}
                      <div className="absolute inset-0 bg-gradient-to-r from-burgundy-light to-burgundy opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                      ...
                      {isAddingToCart[product.id] ? (
                        <div className="relative z-10 flex items-center justify-center space-x-3">
                          <div className="animate-spin rounded-full h-5 w-5 border-2 border-primary-white border-t-transparent"></div>
                          <span>Adding...</span>
                        </div>
                      ) : (
