...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Registration successful! Welcome to Kivra! (This is a demo)');
    } catch (error) {
    ...
    <div className="register-page">
      <div className="auth-container register-container">
        <div className="auth-header">
          ...
          <p>Join Kivra and discover your perfect style</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-options register-options">
            ...
            {errors.agreeToTerms && (
              <span className="error-message checkbox-error">{errors.agreeToTerms}</span>
            )}
